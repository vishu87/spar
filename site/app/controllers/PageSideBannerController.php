...
class PageSideBannerController extends BaseController {
    ...
    public function postAdd(){
        ...
        if($validator->passes()){
            ...
            $id = DB::table("page_side_banner")->insertGetID(array('side_banner_name'=>Input::get("side_banner_name"),'side_banner_image'=>$image));               
    ...
    public function getbanners(){
        ...
        $side_banners = DB::table('page_side_banner')->get();
        $this->layout->main = View::make("admin.page-side-banners.index",array("side_banners"=>$side_banners));
    }

    public function getadd(){
        $this->layout->title = 'Add | Banner';
        $this->layout->top_active = 9;
        $this->layout->main = View::make("admin.page-side-banners.add");
    }

     public function getdelete($side_banner_id){
        $id = DB::table("page_side_banner")->where('id',$side_banner_id)->delete();

          ...
          {{Form::open(array("url"=>"/admin/products/categories/store","method" => "POST","role"=>"form","class" => "form-horizontal","files"=>"true"))}}
            <div class="form-body">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  {{Form::text('product_category','',array("class"=>"form-control", "placeholder"=>"Enter Category Name"))}}
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  {{Form::text('color','',array("class"=>"form-control", "placeholder"=>"Enter Color HEX Code e.g. FF0000"))}}

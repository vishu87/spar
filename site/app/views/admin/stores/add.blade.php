  ...
  <div class="col-md-12 ">
   ...
   <div class="portlet box blue">
            ...
            <div class="portlet-body form">
              {{Form::open(array("url"=>"/admin/stores/store","method" => "POST","role"=>"form","class" => "form-horizontal","files"=>"true"))}}
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      {{Form::text('lat','',array("class"=>"form-control", "placeholder"=>""))}}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      {{Form::text('lng','',array("class"=>"form-control", "placeholder"=>""))}}

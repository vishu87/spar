		...
		<div class="container margin">
			<div id="content">
				...
				<div class="row margin">
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-12 img-padding">								
								{{ HTML::image('frontend/images/banner_home04.jpg','',array("class"=>"other-pro"))}}
							</div>
							<div class="col-md-12 img-padding">
								{{ HTML::image('frontend/images/banner_home05.jpg','',array("class"=>"other-pro"))}}
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 img-padding">
								{{ HTML::image('frontend/images/banner_home06.jpg','',array("class"=>"other-pro"))}}
							</div>
						</div>
					</div>
					<div class="col-md-4">
